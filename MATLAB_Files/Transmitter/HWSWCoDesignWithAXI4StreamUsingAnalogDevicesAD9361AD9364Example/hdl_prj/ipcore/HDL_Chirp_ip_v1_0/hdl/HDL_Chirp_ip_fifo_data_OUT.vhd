-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/zynqRadioHWSWAXI4StreamAD9361AD9364SL/HDL_Chirp_ip_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: HDL_Chirp_ip_fifo_data_OUT
-- Source Path: HDL_Chirp_ip/HDL_Chirp_ip_axi4_stream_write_master/HDL_Chirp_ip_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY HDL_Chirp_ip_fifo_data_OUT IS
...
END HDL_Chirp_ip_fifo_data_OUT;


ARCHITECTURE rtl OF HDL_Chirp_ip_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT HDL_Chirp_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : HDL_Chirp_ip_SimpleDualPortRAM_generic
    USE ENTITY work.HDL_Chirp_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_HDL_Chirp_ip_fifo_data_OUT_classic_ram_generic : HDL_Chirp_ip_SimpleDualPortRAM_generic
