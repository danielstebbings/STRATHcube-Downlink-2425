-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/zynqRadioHWSWAXI4StreamAD9361AD9364SL/HDL_Chirp_ip_axi4_stream_write_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: HDL_Chirp_ip_axi4_stream_write_master
-- Source Path: HDL_Chirp_ip/HDL_Chirp_ip_axi4_stream_write_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY HDL_Chirp_ip_axi4_stream_write_master IS
...
END HDL_Chirp_ip_axi4_stream_write_master;


ARCHITECTURE rtl OF HDL_Chirp_ip_axi4_stream_write_master IS

  -- Component Declarations
  COMPONENT HDL_Chirp_ip_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT HDL_Chirp_ip_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : HDL_Chirp_ip_fifo_data_OUT
    USE ENTITY work.HDL_Chirp_ip_fifo_data_OUT(rtl);

  FOR ALL : HDL_Chirp_ip_fifo_TLAST_OUT
    USE ENTITY work.HDL_Chirp_ip_fifo_TLAST_OUT(rtl);
  ...
  SIGNAL write_packet_size_axi4_stream_write_master_unsigned : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_HDL_Chirp_ip_fifo_data_OUT_inst : HDL_Chirp_ip_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              In_rsvd => user_data,  -- ufix32
              Push => user_valid,  -- ufix1
              Pop => AXI4_Stream_Write_Master_TREADY,  -- ufix1
              Out_rsvd => AXI4_Stream_Write_Master_TDATA_tmp,  -- ufix32
              Empty => fifo_empty_data,  -- ufix1
              AFull => fifo_afull_data  -- ufix1
              );

  u_HDL_Chirp_ip_fifo_TLAST_OUT_inst : HDL_Chirp_ip_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              ...
              Push => user_valid,  -- ufix1
              Pop => AXI4_Stream_Write_Master_TREADY,  -- ufix1
              Out_rsvd => AXI4_Stream_Write_Master_TLAST  -- ufix1
              );

  AXI4_Stream_Write_Master_TVALID <=  NOT fifo_empty_data;

  write_packet_size_axi4_stream_write_master_unsigned <= unsigned(write_packet_size_axi4_stream_write_master);

  const_1 <= to_unsigned(1, 32);

  tlast_size_value <= write_packet_size_axi4_stream_write_master_unsigned - const_1;
