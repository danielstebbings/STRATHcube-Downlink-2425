-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/zynqRadioHWSWAXI4StreamAD9361AD9364SL/HDL_Chirp_ip_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: HDL_Chirp_ip_fifo_TLAST_OUT
-- Source Path: HDL_Chirp_ip/HDL_Chirp_ip_axi4_stream_write_master/HDL_Chirp_ip_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY HDL_Chirp_ip_fifo_TLAST_OUT IS
...
END HDL_Chirp_ip_fifo_TLAST_OUT;


ARCHITECTURE rtl OF HDL_Chirp_ip_fifo_TLAST_OUT IS

  -- Component Declarations
  COMPONENT HDL_Chirp_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : HDL_Chirp_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.HDL_Chirp_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_HDL_Chirp_ip_fifo_TLAST_OUT_classic_ram_singlebit : HDL_Chirp_ip_SimpleDualPortRAM_singlebit
