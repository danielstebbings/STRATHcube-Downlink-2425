...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "GTH4_CH_HSPMUX" -parent ${Page_0}
  ipgui::add_param $IPINST -name "GTH4_PREIQ_FREQ_BST" -parent ${Page_0}
  ipgui::add_param $IPINST -name "GTH4_RXPI_CFG0" -parent ${Page_0}
  ipgui::add_param $IPINST -name "GTH4_RXPI_CFG1" -parent ${Page_0}
...
proc update_PARAM_VALUE.GTH4_CH_HSPMUX { PARAM_VALUE.GTH4_CH_HSPMUX } {
	# Procedure called to update GTH4_CH_HSPMUX when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.GTH4_CH_HSPMUX { PARAM_VALUE.GTH4_CH_HSPMUX } {
	# Procedure called to validate GTH4_CH_HSPMUX
	return true
}

proc update_PARAM_VALUE.GTH4_PREIQ_FREQ_BST { PARAM_VALUE.GTH4_PREIQ_FREQ_BST } {
	# Procedure called to update GTH4_PREIQ_FREQ_BST when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.GTH4_PREIQ_FREQ_BST { PARAM_VALUE.GTH4_PREIQ_FREQ_BST } {
	# Procedure called to validate GTH4_PREIQ_FREQ_BST
	return true
}

proc update_PARAM_VALUE.GTH4_RXPI_CFG0 { PARAM_VALUE.GTH4_RXPI_CFG0 } {
	# Procedure called to update GTH4_RXPI_CFG0 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.GTH4_RXPI_CFG0 { PARAM_VALUE.GTH4_RXPI_CFG0 } {
	# Procedure called to validate GTH4_RXPI_CFG0
	return true
}

proc update_PARAM_VALUE.GTH4_RXPI_CFG1 { PARAM_VALUE.GTH4_RXPI_CFG1 } {
	# Procedure called to update GTH4_RXPI_CFG1 when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.GTH4_RXPI_CFG1 { PARAM_VALUE.GTH4_RXPI_CFG1 } {
	# Procedure called to validate GTH4_RXPI_CFG1
	return true
}
...
proc update_MODELPARAM_VALUE.GTH4_CH_HSPMUX { MODELPARAM_VALUE.GTH4_CH_HSPMUX PARAM_VALUE.GTH4_CH_HSPMUX } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.GTH4_CH_HSPMUX}] ${MODELPARAM_VALUE.GTH4_CH_HSPMUX}
}

proc update_MODELPARAM_VALUE.GTH4_PREIQ_FREQ_BST { MODELPARAM_VALUE.GTH4_PREIQ_FREQ_BST PARAM_VALUE.GTH4_PREIQ_FREQ_BST } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.GTH4_PREIQ_FREQ_BST}] ${MODELPARAM_VALUE.GTH4_PREIQ_FREQ_BST}
}

proc update_MODELPARAM_VALUE.GTH4_RXPI_CFG0 { MODELPARAM_VALUE.GTH4_RXPI_CFG0 PARAM_VALUE.GTH4_RXPI_CFG0 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.GTH4_RXPI_CFG0}] ${MODELPARAM_VALUE.GTH4_RXPI_CFG0}
}

proc update_MODELPARAM_VALUE.GTH4_RXPI_CFG1 { MODELPARAM_VALUE.GTH4_RXPI_CFG1 PARAM_VALUE.GTH4_RXPI_CFG1 } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.GTH4_RXPI_CFG1}] ${MODELPARAM_VALUE.GTH4_RXPI_CFG1}
}
