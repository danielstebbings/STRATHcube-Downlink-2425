...
proc mw_add_axi_dma { name } {
    set axi_dma [ create_bd_cell -type ip -vlnv analog.com:user:axi_dmac:1.0 $name ]
...
proc mw_get_sys_addr_cntrl_space {} {
    ...
    # TODO: Understand the reasoning behind these fall through if statements
    # This proc should return /sys_ps7/Data only
    # In Vivado 2018.2 and 2018.3  [get_bd_addr_spaces -of_objects $sys_cpu]
    # returns empty
    # In Vivado 2019.1 [get_bd_addr_spaces -of_objects $sys_cpu] returns
    # /sys_ps7/Data /sys_ps7/S_AXI_HP1 /sys_ps7/S_AXI_HP2
    # In 2018.3, 2018.2, and 2019.1 
    # [get_bd_addr_spaces -filter "PATH =~ [mw_get_cpu]/Data"] returns /sys_ps7/Data
    #
    # To support 2019.1 I'm changing the order of the following if statements
    # to prioritise the [get_bd_addr_spaces -filter "PATH =~ [mw_get_cpu]/Data"] approach
    #
