...
proc mw_adi_bd_cleanup {} {
    ...
    # Remove the sysid components
    delete_bd_objs [get_bd_cells axi_sysid_0] [get_bd_cells rom_sys_0]
...
proc mw_adi_add_status_led {} { 
    ...
    mw_connect_pin $led_driver_name/clk_ps7 sys_cpu_clk
    mw_connect_pin $led_driver_name/clk_rf util_mw_clkconstr/clk_out
    mw_connect_pin $led_driver_name/rst [mw_project_get ipcore_rst_net]
}
