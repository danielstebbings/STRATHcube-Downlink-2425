        ...
        switch $boardName_in {
            zed {
                ...
                if {$current_vivado_version eq "2023.1"} {
	                ...
	                mw_project_set project_board "avnet.com:zedboard:part0:1.4"
                } else {
            ...
            zc706 {
                ...
                if {$current_vivado_version eq "2023.1"} {
	                ...
	                mw_project_set project_board "xilinx.com:zc706:part0:1.4"
                } else {
...
proc mw_build_bit {} {
    ...
    # Add pause to avoid file-not-found error
    exec sleep 5    
...
proc mw_gen_ps_init {} {
	...
	exec xsct $commonDir/scripts/xilinx/ps_init.tcl $hdf
    cd $curdir
...
proc mw_create_fsbl {} {
	...
	exec xsct $commonDir/scripts/xilinx/create_fsbl.tcl $hdf $XSDK_PATH
