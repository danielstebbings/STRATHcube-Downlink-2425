...
module system_top (
  ...
  ad_iobuf #(.DATA_WIDTH(59)) i_iobuf_bd (
    .dio_t ({gpio_t[59:11], gpio_t[9:0]}),
    .dio_i ({gpio_o[59:11], gpio_o[9:0]}),
    .dio_o ({gpio_i[59:11], gpio_i[9:0]}),
