...
if { $project == "usrpe31x" } {
	mw_connect_pin ps_gpio_i gpio_mux_0/GPIO_OUT_i
	mw_connect_pin ps_gpio_o gpio_mux_0/GPIO_OUT_o
	mw_connect_pin ps_gpio_t gpio_mux_0/GPIO_OUT_t
} else {
