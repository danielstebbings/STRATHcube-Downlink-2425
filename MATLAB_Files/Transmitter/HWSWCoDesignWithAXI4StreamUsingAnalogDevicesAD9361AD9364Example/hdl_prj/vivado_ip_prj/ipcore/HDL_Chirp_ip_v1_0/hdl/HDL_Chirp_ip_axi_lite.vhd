-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/zynqRadioHWSWAXI4StreamAD9361AD9364SL/HDL_Chirp_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: HDL_Chirp_ip_axi_lite
-- Source Path: HDL_Chirp_ip/HDL_Chirp_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY HDL_Chirp_ip_axi_lite IS
...
END HDL_Chirp_ip_axi_lite;


ARCHITECTURE rtl OF HDL_Chirp_ip_axi_lite IS

  -- Component Declarations
  COMPONENT HDL_Chirp_ip_addr_decoder
  ...
  COMPONENT HDL_Chirp_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : HDL_Chirp_ip_addr_decoder
    USE ENTITY work.HDL_Chirp_ip_addr_decoder(rtl);

  FOR ALL : HDL_Chirp_ip_axi_lite_module
    USE ENTITY work.HDL_Chirp_ip_axi_lite_module(rtl);
  ...
  SIGNAL write_packet_size_axi4_stream_write_master_tmp : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_maxTxCount_tmp             : std_logic_vector(15 DOWNTO 0);  -- ufix16
...
BEGIN
  u_HDL_Chirp_ip_addr_decoder_inst : HDL_Chirp_ip_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              write_packet_size_axi4_stream_write_master => write_packet_size_axi4_stream_write_master_tmp,  -- ufix32
              write_maxTxCount => write_maxTxCount_tmp,  -- sfix16
              write_txStart => write_txStart,  -- ufix1
              write_txSel => write_txSel  -- ufix1
              );

  u_HDL_Chirp_ip_axi_lite_module_inst : HDL_Chirp_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_packet_size_axi4_stream_write_master <= write_packet_size_axi4_stream_write_master_tmp;

  write_maxTxCount <= write_maxTxCount_tmp;
